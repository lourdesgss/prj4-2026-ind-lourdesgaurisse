...
* Seb: Bram yapping less
* Seb: In future: it would be good to be able to show something new to canon every weekly meeting (visually represented) 
* Seb: Getting data
* bram: Research-driven work, coming into the collective meetings prepared and ready to share progress, rather than just discussing.
* bram: Highlight the positive, before the negative, but remain critical.
* daniil: stand up meetings
* daniil: sprints? 
* daniil: knowledge sharing 
* lulu: Strong documentation: Link sources, keep them organised
* lulu: Explore professional activities relevant to the PDP (for example the ICT research method)
* lulu: Independent research and study on basic ML methodologies (+1)
* lulu: We should plan ahead what we want to achieve each week/sprint
...
* daniil: unclear git repository set up
* lulu: Attend meetings!!!!!
...
* lulu: Meetings in person over online meetings
* daniil: proper analysis 
* daniil: calm mood 
